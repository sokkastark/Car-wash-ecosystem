...
export default function WorkerSettings() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "20px" }} className="animate-fade-in">
      ...
      <div className="worker-premium-card" style={{ display: "flex", flexDirection: "column", gap: "16px", padding: "20px 24px" }}>
        ...
        <div style={{ height: "1px", background: "rgba(225, 120, 180, 0.06)" }} />
